...
def create_dpo_dataset(input_file: str, output_dir: str, model_family: str = "mistral") -> Dataset:
    ...
    for watermark in grouped:
        ...
        for id in watermark_group:
            ...
            dpo_data.append({
                'prompt': standardize(model_family, system_prompt, instruction.format(no_attack[0].response)),
...
# Usage
input_file = "run/results/detect.tsv"  # Replace with your input file name
output_dir = "dpo_dataset"  # Replace with your desired output directory
model_family = "mistral"  # Replace with your model family
dataset = create_dpo_dataset(input_file, output_dir)